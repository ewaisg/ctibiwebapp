...
export interface RolePermissions {
  canAccessDashboard: boolean; // general dashboard access for Admin and Prime/Internal users
  canAccessSubconsultantDashboard?: boolean; // specific for Subconsultants
...
export const ROLE_PERMISSIONS: Record<UserRole, RolePermissions> = {
  ...
  Subconsultant: {
    canAccessSubconsultantDashboard: true, // dedicated dashboard with limited view for subconsultants
