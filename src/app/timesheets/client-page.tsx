            ...
            <Card>
                ...
                <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                        ...
                        <div>
                            <label className="text-sm font-medium mb-2 block">Work Context</label>
                                    ...
                                    return (
                                        <React.Fragment key={employee.id}>
                                            ...
                                            {isExpanded && employeeEntries.map((entry) => {
                                                ...
                                                // const _workContext = getWorkContext(entry, projects); // not used in UI
                                                // Convert to proper Date object and format consistently
                                                let dateObj: Date | null = null;
                                                ...
                                                return (
                                                    <TableRow key={entry.id} className={`${entrySelected ? "bg-muted/30" : ""} border-l-4 border-l-muted ml-4`}>
                                                        ...
                                                        <TableCell className="text-sm">
                                                            {entry.payItems?.map(pi => pi.payItemName).join(", ") || "N/A"}
                                                        </TableCell>
                                                        <TableCell className="text-sm font-mono">
                                                            {entry.totalHoursActual?.toFixed(2) || "0.00"}
                                                        </TableCell>
                                                        <TableCell>
                                                            <DropdownMenu>
