...
export default function BillableTrendLine({ data = [] as BillableTrendDatum[], title = "Billable vs Non-Billable", subtitle = "Daily trend" }: { data?: BillableTrendDatum[]; title?: string; subtitle?: string }) {
